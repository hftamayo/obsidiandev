...
| #   | Proyecto         | Done | Next                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| --- | ---------------- | ---- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | boabsenses jsb   |      | arreglar los tests de: web{ApiResponseUtilsTest, UnexpectedExceptionHandlerTest}, filtering{GenericSpecificationBuilder}, testear el paquete validation, resolver el test case de CompanyQueryServiceImplTest(getCompanyByCriteria_whenInvalidInput_shouldReturnValidationError)<br><br>-verificar si el frontend debe adaptarse al nuevo procedimiento de paginacion<br><br>-Verificar que cambios necesito hacer en CompanyRepository para soportar los metodos query(searchByCriteria)<br><br>- Validar si necesito un dto+mapper para: softDelete (sólo devuelve un mensaje, listCompanies  y getCompanyById(mensaje de no records found)<br><br><br>- delimitar cuando y como sucede un businessLogicError<br><br>Reqs para el inputValidator:<br>Consider separating concerns:<br>Keep basic input validation in validators<br>Move business validation (like uniqueness checks) to service layer<br>Add more validation rules (email format, length limits, etc.)<br> |
| 2   | boabsenses react |      | testing de los nuevos componentes creados el 27 y 28/10<br><br>Comparar el CompanyAdapter con el CompanyCommandController para verificar que todo vaya alineado<br><br>1. continuar con la dinamica de TDD+refactor<br>3. repository pattern (I like this suggestion)<br>4. react query hooks for caching, background updates<br>5. optimistic updates<br>6. error boundary integration<br>7. validation layer using zod                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
