...
| 2   | boabsenses react |      | - con data en vivo ir puliendo el DataTable junto con los modales<br><br>- luego container del codebase<br><br>-Integration testing de Companycontainer using Jest+React Testing Library<br><br>1. continuar con la dinamica de TDD+refactor<br>3. repository pattern (I like this suggestion)<br>4. react query hooks for caching, background updates<br>5. optimistic updates<br>6. error boundary integration<br>7. validation layer using zod                                                                                                                                                                                                                                  |
