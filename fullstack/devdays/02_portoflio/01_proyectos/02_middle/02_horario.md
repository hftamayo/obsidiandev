...
| #   | Proyecto         | Done | Next                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| --- | ---------------- | ---- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | boabsenses jsb   |      | -verificar si el frontend debe adaptarse al nuevo procedimiento de paginacion<br><br>-Verificar que cambios necesito hacer en CompanyRepository para soportar los metodos query(searchByCriteria)<br><br>- Validar si necesito un dto+mapper para: softDelete (sólo devuelve un mensaje, listCompanies  y getCompanyById(mensaje de no records found)<br><br><br>- delimitar cuando y como sucede un businessLogicError<br><br>Reqs para el inputValidator:<br>Consider separating concerns:<br>Keep basic input validation in validators<br>Move business validation (like uniqueness checks) to service layer<br>Add more validation rules (email format, length limits, etc.)<br><br>- Replicar modelo a OUType<br>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| 2   | boabsenses react |      | Recommendation en CompanyAdapter:<br>- Missing request validation: No domain-level validation before sending requests.<br>- retry logic: BaseApiAdapter has retries: 3 but it's not implemented in httpClient.<br>5. Retry logic not implemented<br>   - `BaseApiAdapter` defines `retries: 3` in `defaultOptions` but it's never used<br>   - `MAX_RETRIES` exists in environment config but isn't used<br>   - No retry implementation in `executeRequest`<br><br>6. No input validation<br>   - IDs can be negative, zero, or invalid (e.g., `updateCompany(-1, ...)`, `deleteCompany(0)`)<br>   - No validation for required fields in `saveCompany`<br>   - No validation for empty/undefined parameters<br><br>7. Hardcoded default pagination values<br>   - `CompanyQueryAdapter.buildListQueryParams`: `page: 1, limit: 10` are hardcoded<br>   - Should use `PAGINATION_LIMIT` from environment config (currently defaults to 5, but adapter uses 10)<br><br>9. No caching strategy for queries<br>   - Query operations (`listCompanies`, `getCompaniesByCriteria`, etc.) don't use caching<br>   - `httpClient` has cache support via `useCache` option, but adapters don't use it<br><br>10. Unclear `_t` timestamp parameter<br>   - Always added to query params (`_t: params._t ?? Date.now()`)<br>   - Purpose unclear (cache busting? request tracking?)<br>   - Should be documented or made optional<br><br>11. No logging/monitoring<br>   - No request/response logging<br>   - No performance metrics<br>   - No operation tracking<br><br>12. No error transformation<br>   - Errors pass through without adapter-level transformation<br>   - Could add context (operation name, parameters) to errors<br><br>13. No request interceptors<br>   - No way to add cross-cutting concerns (logging, metrics, request modification)<br>   - Could benefit from middleware/interceptor pattern<br><br><br><br><br><br>1. continuar con la dinamica de TDD+refactor<br>3. repository pattern (I like this suggestion)<br>4. react query hooks for caching, background updates<br>5. optimistic updates<br>6. error boundary integration<br>7. validation layer using zod |
| 3   | reacttodo        |      | - integration testing con los containers                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| 4   | vanillatstodo    |      | -verificar costos y todo el flow de la pipeline<br>- codear una pipeline que incluya: create IAM role, setup OIDC provider para el github actions, configurar la trust policies, creat el bucket S3 para el terraform state<br>-especializarse en administracion de grafana y de eks<br>- aplicar al cluster el plan de HPA<br>- elaborar un dashboard de verdadero uso<br>- continuar con el plan de getting in production pero usando otro proyecto: integrar vanillatstodo+goresttodo+pg<br><br><br>- GitHubActions: IAM+IaC+CSI driver+Monitoring<br>- ArgoCD: deploy codebase<br>- DevSecOps: SAST, DAST impacta a codebase, en segundo plano algunas medidas para el IAC<br>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
|     |                  |      |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
